...
addon.Locales.zhCN = {
    ...
    SECTION_GROUP_ORDER = "职责顺序", GROUP_ORDER_DESC = "根据职责自动排列五个小队框体。选择职责优先级；相同职责的玩家保持稳定顺序。",
    GROUP_ORDER_POSITION = "优先级 %d", GROUP_ORDER_RESET = "重置职责顺序",
    SECTION_RAID = "团队", RAID_GROUP_NUMBER_SIDE = "团队小队编号", RAID_GROUP_NUMBER_NONE = "无",
    RAID_TEST_MODE = "显示团队测试布局",
    RAID_TEST_IN_RAID = "处于实际团队中时无法使用团队测试模式。",
    ACTION_ASSIGNMENTS = "点击动作", ACTION_NOTE = "每个点击都可以施放当前专精已学会的法术。更改仅在非战斗状态下应用。",
    ACTION_COMBAT = "战斗中无法更改点击动作。", COOLDOWN_BAR = "冷却时间",
}
