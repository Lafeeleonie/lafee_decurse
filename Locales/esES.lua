...
addon.Locales.esES = {
    ...
    VISIBILITY_COMBAT = "El marco no se puede mostrar ni ocultar en combate.", NO_DISPEL = "No se conoce ningún hechizo de disipación compatible para aliados.",
    ...
    SECTION_GLOW = "Resaltado de disipación", GLOW_STYLE = "Estilo", GLOW_STYLE_PULSE = "Pulso", GLOW_STYLE_ANTS = "Borde discontinuo animado", GLOW_STYLE_SOLID = "Fijo",
    ...
    RAID_TEST_MODE = "Mostrar disposición de prueba de banda",
    RAID_TEST_IN_RAID = "El modo de prueba de banda no está disponible durante una banda activa.",
    ...
    ACTION_COMBAT = "Las acciones de clic no se pueden cambiar en combate.", COOLDOWN_BAR = "Tiempo de reutilización",
}
