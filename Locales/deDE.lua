...
addon.Locales.deDE = {
    ...
    CONFIG_SUBTITLE = "Konfiguration des sicheren Gruppenfensters für Dispels und Hilfszauber",
    ...
    VISIBILITY_COMBAT = "Das Fenster kann im Kampf nicht ein- oder ausgeblendet werden.", NO_DISPEL = "Kein unterstützter Dispel-Zauber für Verbündete ist verfügbar.",
    ...
    SHOW_AURAS = "Aurasymbole anzeigen", AURA_GLOW = "Spielerrahmen hervorheben, wenn ein Dispel nötig ist",
    SECTION_GLOW = "Dispel-Hervorhebung", GLOW_STYLE = "Stil", GLOW_STYLE_PULSE = "Pulsieren", GLOW_STYLE_ANTS = "Laufende Punkte", GLOW_STYLE_SOLID = "Statisch",
    ...
    SECTION_RAID = "Schlachtzug", RAID_GROUP_NUMBER_SIDE = "Nummer der Schlachtzugsgruppe", RAID_GROUP_NUMBER_NONE = "Keine",
    RAID_TEST_MODE = "Schlachtzug-Testlayout anzeigen",
    RAID_TEST_IN_RAID = "Der Schlachtzug-Testmodus ist während eines aktiven Schlachtzugs nicht verfügbar.",
    ...
    ACTION_COMBAT = "Klickaktionen können im Kampf nicht geändert werden.", COOLDOWN_BAR = "Abklingzeit",
}
