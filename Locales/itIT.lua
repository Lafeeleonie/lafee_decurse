...
addon.Locales.itIT = {
    ...
    CONFIG_SUBTITLE = "Configurazione del riquadro sicuro del gruppo per dissoluzioni e utilità",
    ...
    VISIBILITY_COMBAT = "Il riquadro non può essere mostrato o nascosto in combattimento.", NO_DISPEL = "Non è noto alcun incantesimo supportato per dissolvere effetti dagli alleati.",
    ...
    SECTION_GLOW = "Evidenziazione della dissoluzione", GLOW_STYLE = "Stile", GLOW_STYLE_PULSE = "Pulsazione", GLOW_STYLE_ANTS = "Formiche in marcia", GLOW_STYLE_SOLID = "Fisso",
    ...
    SECTION_RAID = "Incursione", RAID_GROUP_NUMBER_SIDE = "Numero del gruppo dell’incursione", RAID_GROUP_NUMBER_NONE = "Nessuno",
    RAID_TEST_MODE = "Mostra disposizione di prova dell’incursione",
    RAID_TEST_IN_RAID = "La modalità di prova dell’incursione non è disponibile durante un’incursione attiva.",
    ...
    ACTION_COMBAT = "Le azioni dei clic non possono essere modificate in combattimento.", COOLDOWN_BAR = "Tempo di recupero",
}
