...
addon.Locales.zhTW = {
    ...
    SECTION_GROUP_ORDER = "職責順序", GROUP_ORDER_DESC = "依職責自動排列五個隊伍框架。選擇職責優先順序；相同職責的玩家會維持穩定順序。",
    GROUP_ORDER_POSITION = "優先順序 %d", GROUP_ORDER_RESET = "重設職責順序",
    SECTION_RAID = "團隊", RAID_GROUP_NUMBER_SIDE = "團隊小隊編號", RAID_GROUP_NUMBER_NONE = "無",
    RAID_TEST_MODE = "顯示團隊測試排列",
    RAID_TEST_IN_RAID = "處於實際團隊中時無法使用團隊測試模式。",
    ACTION_ASSIGNMENTS = "點擊動作", ACTION_NOTE = "每個點擊都可以施放目前專精已學會的法術。變更僅會在非戰鬥狀態下套用。",
    ACTION_COMBAT = "戰鬥中無法變更點擊動作。", COOLDOWN_BAR = "冷卻時間",
}
